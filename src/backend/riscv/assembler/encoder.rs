...
fn parse_vtypei(operands: &[Operand], start_idx: usize) -> Result<u32, String> {
...
fn encode_vsetvli(operands: &[Operand]) -> Result<EncodeResult, String> {
    let rd = get_reg(operands, 0)?;
    let rs1 = get_reg(operands, 1)?;
...
fn encode_vsetivli(operands: &[Operand]) -> Result<EncodeResult, String> {
    let rd = get_reg(operands, 0)?;
...
fn encode_vsetvl(operands: &[Operand]) -> Result<EncodeResult, String> {
    let rd = get_reg(operands, 0)?;
    let rs1 = get_reg(operands, 1)?;
    let rs2 = get_reg(operands, 2)?;
...
fn encode_vload(operands: &[Operand], width: u32, lumop: u32) -> Result<EncodeResult, String> {
...
fn encode_vstore(operands: &[Operand], width: u32, sumop: u32) -> Result<EncodeResult, String> {
...
fn encode_v_arith_vv(operands: &[Operand], funct6: u32) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
...
fn encode_v_arith_vx(operands: &[Operand], funct6: u32) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
    let vs2 = get_vreg(operands, 1)?;
    let rs1 = get_reg(operands, 2)?;
    let vm: u32 = 1;
...
fn encode_v_arith_vi(operands: &[Operand], funct6: u32) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
    let vs2 = get_vreg(operands, 1)?;
...
fn encode_vmv_v_v(operands: &[Operand]) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
...
fn encode_vmv_v_x(operands: &[Operand]) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
    let rs1 = get_reg(operands, 1)?;
...
fn encode_vmv_v_i(operands: &[Operand]) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
...
fn encode_vid_v(operands: &[Operand]) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
...
fn encode_v_crypto_vi(operands: &[Operand], funct6: u32) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
    let vs2 = get_vreg(operands, 1)?;
...
fn encode_v_crypto_vv(operands: &[Operand], funct6: u32) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
    let vs2 = get_vreg(operands, 1)?;
    let vs1 = get_vreg(operands, 2)?;
...
fn encode_v_crypto_vs(operands: &[Operand], funct6: u32) -> Result<EncodeResult, String> {
    let vd = get_vreg(operands, 0)?;
    let vs2 = get_vreg(operands, 1)?;
